...
""""to get this to work on Cheyennes VM and test"""":

1. I send my entire project folder to Cheyenne

2. Install Python on Cheyennes VM

3. Cheyenne opens terminal inside the folder
-Run these commands:
...
8. Run the attack from my laptop

9. Check logs on Cheyenne’s VM
-open this file on her VM:
-logs/auth.log
